    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-800 mb-3">Report Found Item</h1>
          <p className="text-gray-600 text-lg">
            Help reunite lost items with their owners. Fill out the details below.
          </p>
        </div>
            ...
            {[1, 2, 3, 4].map((num) => (
              <div key={num} className="flex items-center">
                <div className={`
                  ...
                  ${step >= num 
                    ? 'bg-gradient-to-r from-green-600 to-emerald-600 text-white scale-110' 
