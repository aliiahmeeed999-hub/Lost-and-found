...
async function uploadToCloudinary(base64Image, folder = 'items') {
    try {
        ...
        const uploadResult = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$my$2d$project$2f$lost$2d$found$2d$app$2f$node_modules$2f$cloudinary$2f$cloudinary$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["v2"].uploader.upload(base64Image, {
            folder: folder,
            resource_type: 'auto',
            transformation: [
                {
...
async function POST(request) {
    try {
        ...
        const { title, description, category, status, itemStatus, locationLost, locationFound, locationDetails, dateLost, dateFound, color, brand, distinguishingFeatures, contactInfo, rewardAmount, tags, images// Array of base64 data URIs from frontend
         } = body;
        // Validation
        if (!title || !title.trim()) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$my$2d$project$2f$lost$2d$found$2d$app$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1850cab0._.js.map