...
"[project]/Desktop/my-project/lost-found-app/src/app/api/match/confirm/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const match = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$my$2d$project$2f$lost$2d$found$2d$app$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].match.findUnique({
            where: {
                id: matchId
            },
            include: {
        ...
        // Confirm the match
        const confirmedMatch = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$my$2d$project$2f$lost$2d$found$2d$app$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].match.update({
            where: {
                id: matchId
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5ce655e1._.js.map